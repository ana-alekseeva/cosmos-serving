"""Synthetic replay-set generator (MOCK): (re)generates the committed policy/mock/manifest.json.
...
# Instruction pool for the synthetic fixture (stands in for real per-episode instructions).
_INSTRUCTIONS = (
...
def build_mock_replay(n: int = DEFAULT_REPLAY_SIZE, *,
    ...
    Shapes are constant (static-shape requirement); task/episode/instruction vary."""
