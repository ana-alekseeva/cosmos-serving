...
NB: distinct from policy/configs.py, which BUILDS the optimization ladders (R0-R4, G0-G5,
...
class RunConfig:
    ...
    configurations: tuple = ()                    # cids to run; empty = full matrix (R0-R4,G0-G5,E0-E6)
